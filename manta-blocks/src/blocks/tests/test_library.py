...
from blocks.library.myopic_capacity_expansion import MyopicCapacityExpansion
from blocks.library.overnight_capacity_expansion import OvernightCapacityExpansion
from blocks.library.pypsa_helpers import to_network
from blocks.library.rolling_horizon_dispatch import RollingHorizonDispatch
from blocks.library.time_cluster import ClusterTime
...
def test_dispatch_can_run_against_capacities_another_block_chose(
    single_period_record, tmp_path
):
    expanded = _run(
        OvernightCapacityExpansion, {}, single_period_record, tmp_path / "expanded"
    )
