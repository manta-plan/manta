...
from blocks.tests.fakes import FakeNeedsUpstream, FakePassthrough
...
def test_an_invalid_playbook_never_reaches_the_runner(initial_record):
    import pytest
    ...
    with pytest.raises(PlaybookValidationError):
        execute_playbook(pb, initial_record, {}, output_prefix="out", runner=runner)
    assert runner.calls == []
